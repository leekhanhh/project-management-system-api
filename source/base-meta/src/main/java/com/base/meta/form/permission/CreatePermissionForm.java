package com.base.meta.form.permission;
...
public class CreatePermissionForm {
    ...
    private String name;
    @NotEmpty(message = "action cant not be empty")
    ...
    @NotEmpty(message = "nameGroup cant not be empty")
    @ApiModelProperty(name = "nameGroup", required = true)
    private String nameGroup;
    @NotEmpty(message = "permissionCode cant not be empty")
