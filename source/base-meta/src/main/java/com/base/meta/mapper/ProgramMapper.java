...
public interface ProgramMapper {
    ...
    @Mapping(source = "startDate", target = "startDate")
    @Mapping(source = "endDate", target = "endDate")
    @Mapping(source = "account", target = "programOwner", qualifiedByName = "fromAccountToAutoCompleteDto")
    @Mapping(source = "developer", target = "assignedDeveloper", qualifiedByName = "fromAccountToAutoCompleteDto")
    @Mapping(source = "tester", target = "assignedTester", qualifiedByName = "fromAccountToAutoCompleteDto")
    @Mapping(source = "status", target = "programStatus", qualifiedByName = "fromEntityToAutoCompleteNameToDto")
