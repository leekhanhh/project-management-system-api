...
public class TestSuiteExecutionMapperImpl implements TestSuiteExecutionMapper {
    ...
    @Override
    public TestSuiteExecution fromCreateTestSuiteExecutionFormToEntity(CreateTestSuiteExecutionForm createTestSuiteExecutionForm) {
        if ( createTestSuiteExecutionForm == null ) {
            return null;
        }
    ...
    @Override
    public void updateTestSuiteExecutionFromEntity(UpdateTestSuiteExecutionForm updateTestSuiteExecutionForm, TestSuiteExecution testSuiteExecution) {
        if ( updateTestSuiteExecutionForm == null ) {
            return;
        }

        if ( updateTestSuiteExecutionForm.getOrderNumber() != null ) {
            testSuiteExecution.setOrderNumber( updateTestSuiteExecutionForm.getOrderNumber() );
        }
        if ( updateTestSuiteExecutionForm.getFlag() != null ) {
            testSuiteExecution.setFlag( updateTestSuiteExecutionForm.getFlag() );
        }
    }
