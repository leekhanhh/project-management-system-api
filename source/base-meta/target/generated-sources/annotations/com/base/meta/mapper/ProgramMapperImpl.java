...
public class ProgramMapperImpl implements ProgramMapper {
    ...
    public ProgramDto fromDtoToEntity(Program program) {
        ...
        if ( program.getEndDate() != null ) {
            programDto.setEndDate( new SimpleDateFormat( "dd/MM/yyyy" ).format( program.getEndDate() ) );
        }
        ...
        if ( program.getStartDate() != null ) {
            programDto.setStartDate( new SimpleDateFormat( "dd/MM/yyyy" ).format( program.getStartDate() ) );
        }
    ...
    @Override
    public ProgramDto fromEntityToAutoCompleteNameToDto(Program program) {
        if ( program == null ) {
            return null;
        }
