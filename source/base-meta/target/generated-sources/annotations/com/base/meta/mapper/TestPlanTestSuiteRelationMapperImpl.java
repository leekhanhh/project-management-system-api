...
public class TestPlanTestSuiteRelationMapperImpl implements TestPlanTestSuiteRelationMapper {
    ...
    @Override
    public TestPlanTestSuiteRelation fromCreateTestPlanTestSuiteRelationFormToEntity(CreateTestPlanTestSuiteRelationForm createTestPlanTestSuiteRelationForm) {
        if ( createTestPlanTestSuiteRelationForm == null ) {
            return null;
        }

        TestPlanTestSuiteRelation testPlanTestSuiteRelation = new TestPlanTestSuiteRelation();

        return testPlanTestSuiteRelation;
    }
