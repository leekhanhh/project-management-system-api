...
public class TestPlanTestSuiteRelationMapperImpl implements TestPlanTestSuiteRelationMapper {
    ...
    @Override
    public TestSuiteDto fromShortenedEntityToTestPlanTestSuiteRelationDto(TestPlanTestSuiteRelation testPlanTestSuiteRelation) {
        if ( testPlanTestSuiteRelation == null ) {
            return null;
        }
        ...
        testSuiteDto.setName( testPlanTestSuiteRelationTestSuiteName( testPlanTestSuiteRelation ) );
        testSuiteDto.setDescription( testPlanTestSuiteRelationTestSuiteDescription( testPlanTestSuiteRelation ) );
        testSuiteDto.setId( testPlanTestSuiteRelationTestSuiteId( testPlanTestSuiteRelation ) );
        testSuiteDto.setProgram( programMapper.fromEntityToAutoCompleteNameToDto( testPlanTestSuiteRelationTestSuiteProgram( testPlanTestSuiteRelation ) ) );
        testSuiteDto.setDisplayId( testPlanTestSuiteRelationTestSuiteDisplayId( testPlanTestSuiteRelation ) );
        testSuiteDto.setAccount( accountMapper.fromEntityToAutoCompleteNameToDto( testPlanTestSuiteRelationTestSuiteAccount( testPlanTestSuiteRelation ) ) );

        return testSuiteDto;
    }

    @Override
    public List<TestSuiteDto> fromShortenedEntitiesToTestPlanTestSuiteRelationDtos(List<TestPlanTestSuiteRelation> testPlanTestSuiteRelations) {
        if ( testPlanTestSuiteRelations == null ) {
            return null;
        }

        List<TestSuiteDto> list = new ArrayList<TestSuiteDto>( testPlanTestSuiteRelations.size() );
        for ( TestPlanTestSuiteRelation testPlanTestSuiteRelation : testPlanTestSuiteRelations ) {
            list.add( fromShortenedEntityToTestPlanTestSuiteRelationDto( testPlanTestSuiteRelation ) );
        }
    ...
    private String testPlanTestSuiteRelationTestSuiteName(TestPlanTestSuiteRelation testPlanTestSuiteRelation) {
        if ( testPlanTestSuiteRelation == null ) {
            return null;
        }
        TestSuite testSuite = testPlanTestSuiteRelation.getTestSuite();
        if ( testSuite == null ) {
            return null;
        }
    ...
    private String testPlanTestSuiteRelationTestSuiteDescription(TestPlanTestSuiteRelation testPlanTestSuiteRelation) {
        if ( testPlanTestSuiteRelation == null ) {
            return null;
        }
        TestSuite testSuite = testPlanTestSuiteRelation.getTestSuite();
    ...
    private Long testPlanTestSuiteRelationTestSuiteId(TestPlanTestSuiteRelation testPlanTestSuiteRelation) {
        if ( testPlanTestSuiteRelation == null ) {
            return null;
        }
        TestSuite testSuite = testPlanTestSuiteRelation.getTestSuite();
    ...
    private Program testPlanTestSuiteRelationTestSuiteProgram(TestPlanTestSuiteRelation testPlanTestSuiteRelation) {
        if ( testPlanTestSuiteRelation == null ) {
            return null;
        }
        TestSuite testSuite = testPlanTestSuiteRelation.getTestSuite();
        ...
        Program program = testSuite.getProgram();
        if ( program == null ) {
            return null;
        }
        return program;
    ...
    private String testPlanTestSuiteRelationTestSuiteDisplayId(TestPlanTestSuiteRelation testPlanTestSuiteRelation) {
        if ( testPlanTestSuiteRelation == null ) {
            return null;
        }
        TestSuite testSuite = testPlanTestSuiteRelation.getTestSuite();
        ...
        String displayId = testSuite.getDisplayId();
        if ( displayId == null ) {
            return null;
        }
        return displayId;
    ...
    private Account testPlanTestSuiteRelationTestSuiteAccount(TestPlanTestSuiteRelation testPlanTestSuiteRelation) {
        if ( testPlanTestSuiteRelation == null ) {
            return null;
        }
        TestSuite testSuite = testPlanTestSuiteRelation.getTestSuite();
        ...
        Account account = testSuite.getAccount();
        if ( account == null ) {
            return null;
        }
        return account;
