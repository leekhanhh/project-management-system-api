...
public class TestCaseMapperImpl implements TestCaseMapper {
    ...
    @Override
    public TestCase fromCreateTestCaseFromTestCaseUpload(TestCaseUpload testCaseUpload) {
        ...
        testCase.setCreatedBy( testCaseUpload.getCreatedBy() );
